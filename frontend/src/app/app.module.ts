...
import {NeuralBackgroundComponent} from './components/neural-background/neural-background.component';
...
import {NavItemComponent}from './components/floating-nav/nav-item/nav-item.component';
